...
def calpfnew(_date, replace=False):
    ...
    # print(stocks)
    # 低市盈率
    peDf = readLastTTMPEs(stocks, _date)
    if peDf is None:
        return
...
class ReportItem:
    ...
    def __init__(self, ts_code):
        ...
        valuation = sqlrw.readValuation(ts_code)
        # self.name = myStockValuation[2]
        # guzhiData = sqlrw.getGuzhi(ts_code)
        #
        # # 股票评分
        # self.pf = myStockValuation[3]
        # self.lowpe = myStockValuation[5]
        # self.lowhype = myStockValuation[8]
        # self.lowpeg = myStockValuation[18]
        # self.wdzz = myStockValuation[20]
        # self.lowpez200 = myStockValuation[22]
        # self.lowpez1000 = myStockValuation[24]
        #
        # # 当前TTMPE在近200、1000个工作日中的Z值
        # self.pez200 = myStockValuation[21]
        # self.pez1000 = myStockValuation[23]
        #
        # # 当前TTMPE
        # self.curTTMPE = myStockValuation[4]
        # self.peg = myStockValuation[17]
        # self.hype = myStockValuation[7]
        # # 未来三年PE预计
        # self.PEYuji = [guzhiData[4], guzhiData[5], guzhiData[6]]
        # # 最近6个季度TTM利润增长率
        # # self.profitsInc = [myStockValuation[9], myStockValuation[10],
        # #                      myStockValuation[11], myStockValuation[12],
        # #                      myStockValuation[13], myStockValuation[14]]
        # # 最近6个季度TTM利润平均增长率
        # self.profitsIncAvg = myStockValuation[15]
        # # 根据平均绝对离差计算的增长率差异水平
        # self.profitsIncMad = guzhiData[14]
        # # 根据标准差计算的增长率差异水平
        # self.profitsIncStand = myStockValuation[16]
        # # 当前TTMPE参考最近200个工作日水平
        # self.PERate200 = myStockValuation[25]
        # self.PEZ200 = myStockValuation[21]
        # # 当前TTMPE参考最近1000个工作日水平
        # self.PERate1000 = myStockValuation[26]
        # self.PEZ1000 = myStockValuation[23]
        #
        ...
        #
        # # 最近三年TTM利润增长率水平
        # self.profitsInc3Years = readStockProfitInc(ts_code)
        # # 所属1级行业
        # self.lv1Code = lv1Code
        # self.lv1Name = readClassifyName(lv1Code)
        # self.lv1Inc = getHYProfitsIncRates(lv1Code)
        # # 所属2级行业
        # self.lv2Code = lv2Code
        # self.lv2Name = readClassifyName(lv2Code)
        # self.lv2Inc = getHYProfitsIncRates(lv2Code)
        # # 所属3级行业
        # self.lv3Code = lv3Code
        # self.lv3Name = readClassifyName(lv3Code)
        # self.lv3Inc = getHYProfitsIncRates(lv3Code)
        # # 所属4级行业
        # self.lv4Code = lv4Code
        # self.lv4Name = readClassifyName(lv4Code)
        # self.lv4Inc = getHYProfitsIncRates(lv4Code)
        #
        # # 同行业股票
